  ...
  return (
    <div className='flex items-center -mx-[75px] bg-blue-300 h-[848px]  relative overflow-hidden '>  
      ...
      {data && genres &&
        ...
        <>
           <img loading='lazy' className=' absolute w-full ' src={`https://image.tmdb.org/t/p/original/${movieInfo.backdrop_path}`}/>
          ...
          {data.results.map(movie =>
            <SwiperSlide key={movie.id}  className='topRatedMoviesSlide skeleton' >
